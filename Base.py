...
class Base:
    ...
    def load_debug_form(self):
        pass

    def load_main(self):
        if Globals.selected_categories != [] or self.selected_keywords != []:
...
base_form = Base()
print(base_form.get_images_from_gallery(base_form.local_gallery))